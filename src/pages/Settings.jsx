            ...
            <BgContainer>
                <div className=' w-max md:w-[700px]  h-full mx-auto bg-slate-100 py-10 px-2 m-2'>
                    <div className=' flex flex-col gap-5 px-6 py-10'>
                        ...
                        <Link to='/' className=" py-[2px] bg-green-600 border-2 border-transparent text-white text-lg md:text-2xl hover:text-green-600 hover:border-green-600 hover:bg-slate-100  rounded-md px-5"><i className="fa-solid fa-address-card"></i> Change Info</Link>
